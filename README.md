...
> A [Plex](https://plex.tv/) bundle designed to support watching [Pluralsight](https://www.pluralsight.com) videos

This bundle allows you to watch Pluralsight videos on your Plex client.

## Install

Download the .zip file from this repository. Unzip the file and remove any extra identifiers (like '-master') so you have a folder called Pluralsight.bundle. Copy or move the Pluralsight.bundle folder to your Plex plugin folder (see https://support.plex.tv/hc/en-us/articles/201106098).
